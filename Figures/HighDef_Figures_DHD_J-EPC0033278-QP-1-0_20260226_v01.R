...
# made out side of microsoft office.  So this remakes the figures in the propper scale.

# Before you run this scrip you have to run either of these two scripts first.
# N_Am_Meta_DHD_J-EPC0033278-QP-1-0_20230920_v01.R
# N_Am_Meta_DHD_J-EPC0033278-QP-1-0_20240201_v02.R
...
# If making files from N_Am_Meta_DHD_J-EPC0033278-QP-1-0_20240201_v02.R to remove
# USA otherwise skip.
...
# The following are files that are dependent on forestsubsort
...
# If you ran N_Am_Meta_DHD_J-EPC0033278-QP-1-0_20240201_v02.R you need to run this
# script that removes studies with USA data.
EnumboxDF1 <- EnumboxDF %>% filter(AniboxC!="USA")


# Creates a boxplot of the generated enumerated data in tiff formate
